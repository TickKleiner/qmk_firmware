...
#include "keyboards/ergohaven/src/keycodes.h"

const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
LAYOUT( \

    KC_GRV,   KC_1,    KC_2,    KC_3,     KC_4,     KC_5,                                          KC_6,  KC_7,     KC_8,     KC_9,   KC_0,    KC_BSPC, \
    KC_ESC,   EH_PRINFO,    KC_W,    KC_E,     KC_R,     KC_T,                                          KC_Y,  KC_U,     KC_I,     KC_O,   KC_P,    KC_BSLS, \
    KC_TAB,   KC_A,    KC_S,    KC_D,     KC_F,     KC_G,                                          KC_H,  KC_J,     KC_K,     KC_L,   KC_SCLN, KC_QUOT, \
    KC_LSFT,  KC_Z,    KC_X,    KC_C,     KC_V,     KC_B, KC_LBRC,                               KC_RBRC, KC_N,  KC_M,     KC_COMM,  KC_DOT, KC_SLSH, KC_RSFT, \
                        KC_LGUI, KC_LALT,  KC_LCTL,  TG(1), KC_SPC,       KC_ENT, TG(0), KC_RCTL, KC_RALT,  KC_RGUI \
),
LAYOUT( \
    ...
    _______, _______, _______, KC_CAPS, _______,  KC_DEL, _______,                                   _______, KC_PSCR, KC_1,    KC_2,    KC_3,   _______, _______,
...
LAYOUT( \
    ...
    _______, _______, KC_ASTR, KC_COLN, KC_SLSH, _______, _______,                                    _______, _______, KC_PIPE, KC_TILD, KC_AMPR, _______,  _______,
...
LAYOUT(
    ...
    _______, _______, _______, _______, _______, CG_TOGG, _______,                                _______, _______, KC_MPRV, KC_MPLY, KC_MNXT, _______, DM_RSTP,
                        _______, _______, _______, _______, _______,        _______, _______,  _______, _______, _______
),
};
